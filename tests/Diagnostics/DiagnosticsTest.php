...
/**
 * Diagnostics Test
 * It is works only in Vagrant environment (SNMP sim, Bird route servers, ...)
 *
...
class DiagnosticsTest extends TestCase
{
    ...
    /**
     * Result creation test on customer ID 4 (Eyeball ISP)
     *
     */
    public function testCollection(): void
    {
        ...
        $this->resultSets[] = $diagnostics->getCustomerDiagnostics($customer);
        ...
        foreach( $customer->virtualInterfaces as $vi ) {
            ...
            $this->resultSets[] = $viSet;

        }

        $this->assertIsArray($this->resultSets);
