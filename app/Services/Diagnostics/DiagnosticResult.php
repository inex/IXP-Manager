...
class DiagnosticResult
{
    ...
    public const int TYPE_UNKNOWN  = 400;
    ...
    public static array $RESULT_TYPES_ICON_STYLE = [
        ...
        self::TYPE_UNKNOWN => 'tw-bg-red-50 tw-text-red-700 tw-ring-black-700/10',
    ...
    public function __construct(
        ...
        public int $auth = User::AUTH_SUPERUSER,    // whether the diagnostic result should be visible to the member
