 ...
 * @method static Builder<static>|PatchPanelPortHistory masterPort()
 * @method static Builder<static>|PatchPanelPortHistory newModelQuery()
 * @method static Builder<static>|PatchPanelPortHistory newQuery()
 * @method static Builder<static>|PatchPanelPortHistory query()
 * @method static Builder<static>|PatchPanelPortHistory whereAssignedAt($value)
 * @method static Builder<static>|PatchPanelPortHistory whereCeaseRequestedAt($value)
 * @method static Builder<static>|PatchPanelPortHistory whereCeasedAt($value)
 * @method static Builder<static>|PatchPanelPortHistory whereChargeable($value)
 * @method static Builder<static>|PatchPanelPortHistory whereColoBillingRef($value)
 * @method static Builder<static>|PatchPanelPortHistory whereColoCircuitRef($value)
 * @method static Builder<static>|PatchPanelPortHistory whereConnectedAt($value)
 * @method static Builder<static>|PatchPanelPortHistory whereCreatedAt($value)
 * @method static Builder<static>|PatchPanelPortHistory whereCustId($value)
 * @method static Builder<static>|PatchPanelPortHistory whereCustomer($value)
 * @method static Builder<static>|PatchPanelPortHistory whereDescription($value)
 * @method static Builder<static>|PatchPanelPortHistory whereDuplexMasterId($value)
 * @method static Builder<static>|PatchPanelPortHistory whereId($value)
 * @method static Builder<static>|PatchPanelPortHistory whereInternalUse($value)
 * @method static Builder<static>|PatchPanelPortHistory whereNotes($value)
 * @method static Builder<static>|PatchPanelPortHistory whereNumber($value)
 * @method static Builder<static>|PatchPanelPortHistory whereOwnedBy($value)
 * @method static Builder<static>|PatchPanelPortHistory wherePatchPanelPortId($value)
 * @method static Builder<static>|PatchPanelPortHistory wherePrivateNotes($value)
 * @method static Builder<static>|PatchPanelPortHistory whereState($value)
 * @method static Builder<static>|PatchPanelPortHistory whereSwitchport($value)
 * @method static Builder<static>|PatchPanelPortHistory whereTicketRef($value)
 * @method static Builder<static>|PatchPanelPortHistory whereUpdatedAt($value)
 * @mixin Eloquent
 */
...
class PatchPanelPortHistory extends Model
{
     ...
     *
     * @return BelongsTo<PatchPanelPort, PatchPanelPortHistory>
     */
     ...
     *
     * @return HasMany<PatchPanelPortHistoryFile, PatchPanelPortHistory>
     */
