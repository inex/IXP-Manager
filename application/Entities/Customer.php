...
class Customer
{
     ...
     * Add MeetingsUpdated
     *
     * @param Entities\Meeting $meetingsUpdated
     * @return Customer
     */
    public function addMeetingsUpdated(\Entities\Meeting $meetingsUpdated)
    {
        $this->MeetingsUpdated[] = $meetingsUpdated;
    
        return $this;
    }

    /**
     * Remove MeetingsUpdated
     *
     * @param Entities\Meeting $meetingsUpdated
     */
    public function removeMeetingsUpdated(\Entities\Meeting $meetingsUpdated)
    {
        $this->MeetingsUpdated->removeElement($meetingsUpdated);
    }
