    ...
    $.getJSON( "{genUrl controller='dashboard' action='my-peering-matrix-peered-state'}/id/" + pId + "/vlan/" + pVlan,
            function( data ) {
                ...
                switch( data['newstate'] )
                {
                    case 0:
                        $('#myPeeredState-' + pId).append(
                            '<img src="{genUrl}/images/22x22/no.png" width="22" height="22" border="0" alt="NO" />'
                        );
                        break;
                    case 1:
                        $('#myPeeredState-' + pId).append(
                            '<img src="{genUrl}/images/22x22/yes.png" width="22" height="22" border="0" alt="YES" />'
                        );
                        break;
                    case 2:
                        $('#myPeeredState-' + pId).append(
                            '<img src="{genUrl}/images/22x22/waiting.png" width="22" height="22" border="0" alt="WAITING" />'
                        );
                        break;
                    case 3:
                        $('#myPeeredState-' + pId).append(
                            '<img src="{genUrl}/images/22x22/never.png" width="22" height="22" border="0" alt="NEVER" />'
                        );
                        break;
                    case 4:
                        $('#myPeeredState-' + pId).append(
                            '<img src="{genUrl}/images/22x22/unknown.png" width="22" height="22" border="0" alt="UNKNOWN" />'
                        );
                        break;
                    default:
                        $('#myPeeredState-' + pId).append(
