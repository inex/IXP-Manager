...
{$options.mailinglist.cmd.list_members} {$name} | {$apppath}/../bin/ixptool.php -a cli.mailing-list-init --p1={$name}

# Add new subscriptions to the list
{$apppath}/../bin/ixptool.php -a cli.mailing-list-subscribed --p1={$name} | {$options.mailinglist.cmd.add_members} {$name} >/dev/null

# Remove subscriptions from the list
{$apppath}/../bin/ixptool.php -a cli.mailing-list-unsubscribed --p1={$name} | {$options.mailinglist.cmd.remove_members} {$name} >/dev/null
