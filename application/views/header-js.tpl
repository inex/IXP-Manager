{if isset( $config.use_minified_js ) and $config.use_minified_js}
    <script type="text/javascript" src="{genUrl}/js/min.bundle-v13.js"></script>
{else}
    ...
    <script type="text/javascript" src="{genUrl}/js/261-wysihtml5-0.3.0_rc1-simple-parser.js"></script>
    <script type="text/javascript" src="{genUrl}/js/269-wysihtml5-0.3.0_rc1.js"></script>
