 ...
 */
class Vlaninterface extends BaseVlaninterface
{
    public function setUp()
    {
        parent::setUp();

        $this->hasOne( 'Ipv4address',       array( 'local' => 'ipv4addressid',       'foreign' => 'id') );
        $this->hasOne( 'Ipv6address',       array( 'local' => 'ipv6addressid',       'foreign' => 'id') );
