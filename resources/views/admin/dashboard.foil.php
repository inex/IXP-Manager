                              ...
                              <tbody class="tw-text-sm">
                                <?php foreach( $t->stats[ "percentByVlan" ] as $stats  ): ?>
                                    <tr>
                                        ...
                                        <td class="tw-text-right">
                                            <a href="<?= route( "switch@configuration", [ "vlan" => array_search( $stats[ 'vlanname' ], $t->stats[ 'vlans' ], true ) ] ) ?>">
                                                <?= $stats[ 'count' ] ?>
                                            </a>
                                        </td>
                                        <td class="tw-text-right">
                              ...
                              <tbody class="tw-text-sm">
                                <?php foreach( $t->stats[ "custsByLocation" ] as $loc => $cnt  ): ?>
                                    <tr>
                                        ...
                                        <td class="tw-text-right">
                                            <a href="<?= route( "switch@configuration", [ "location" => array_search( $loc , $t->stats['locations'], true ) ] ) ?>">
                                                <?= $cnt ?>
                                            </a>
                                        </td>
                                    </tr>
                                          ...
                                          <?php foreach( $t->stats[ "speeds"] as $s => $c ): ?>
                                              <td class="tw-text-right">
                                                  <?php if( isset( $speed[ $s ] ) ): ?>
                                                      <a href="<?= route( "switch@configuration", [ "location" => array_search( $location , $t->stats['locations'], true ), "speed" => $s ] ) ?>">
                                                          <?= $speed[ $s ] ?>
                                                      </a>
                                          ...
                                          <?php foreach( $t->stats[ "speeds"] as $speed => $count ): ?>
                                              <td class="tw-text-right">
                                                  <?php if( isset( $spds[ $speed ] ) ): ?>
                                                      <a href="<?= route( "switch@configuration", [ "infra" => array_search( $inf , $t->stats['infras'], true ), "speed" => $speed ] ) ?>">
                                                          <?= $spds[ $speed ] ?>
                                                      </a>
                                  ...
                                  <?php foreach( $t->stats[ "rsUsage"] as  $vlan ): ?>
                                      <tr>
                                          ...
                                          <td class="tw-text-right">
                                              ...
                                              <a href="<?= route( "switch@configuration", [ "vlan" => array_search( $vlan[ 'vlanname' ] , $t->stats['vlans'], true ) , "rs-client" => 1 ] ) ?>">
                                                  <?= $vlan[ 'rsclient_count' ] ?>
                                              </a>
                                          </td>
                                          <td class="tw-text-right">
                                  ...
                                  <?php foreach( $t->stats[ "ipv6Usage"] as  $vlan ): ?>
                                      <tr>
                                          ...
                                          <td class="tw-text-right">
                                              ...
                                              <a href="<?= route( "switch@configuration", [ "vlan" => array_search( $vlan[ 'vlanname' ] , $t->stats['vlans'], true ) , "ipv6-enabled" => 1 ] ) ?>">
                                                  <?= $vlan[ 'ipv6_count' ] ?>
                                              </a>
                                          </td>
                                          <td class="tw-text-right">
