...
{$custPorts.discards[] = "ifInDiscards#`$mrtgId`&1.3.6.1.4.1.1916.1.4.14.1.1#`$mrtgId`:`$switch->getSnmppasswd()`@`$switch->getHostname()`:::::2"}
{$custLagPorts.discards[] = "ifInDiscards#`$mrtgId`&1.3.6.1.4.1.1916.1.4.14.1.1#`$mrtgId`:`$switch->getSnmppasswd()`@`$switch->getHostname()`:::::2"}
{else}
