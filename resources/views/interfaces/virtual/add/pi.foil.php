...
<div class="row mt-4">
    ...
    <h3 class="col-md-12">
        Physical Interfaces
        <a class="btn btn-white btn-sm" id="add-pi" href="<?= route('physical-interface@create' , [ 'vi' => $t->vi->getId() ] ) ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <a class="btn btn-white" id="view-pi-<?= $pi->getId()?>" href="<?= route( 'physical-interface@view' , [ 'pi' => $pi->getId() ] )?>" title="View">
                                        <i class="fa fa-eye"></i>
                                    </a>

                                    <a class="btn btn-white" id="edit-pi-<?= $pi->getId()?>" href="<?= route( 'physical-interface@edit-from-virtual-interface' , [ 'pi' => $pi->getId() , 'vi' => $t->vi->getId() ] )?>" title="Edit">
                                        <i class="fa fa-pencil"></i>
                                    </a>

                                    <a class="btn btn-white btn-delete-pi" <?php if( $t->resellerMode() && ( $pi->getPeeringPhysicalInterface() || $pi->getFanoutPhysicalInterface() ) ) :?> data-related="1" <?php endif; ?> data-type="<?= $pi->getSwitchPort()->getType() ?>" data-url="<?= route( 'physical-interface@delete', [ 'pi' => $pi->getId() ] ) ?>" href="#" title="Delete Physical Interface">
            ...
            <div class="alert alert-info" role="alert">
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-sm-12">
                        ...
                        <a class="btn btn-white" href="<?= route('physical-interface@create' , [ 'vi' => $t->vi->getId() ] ) ?>">
                            Add one now...
                        </a>
                    </div>
                </div>
