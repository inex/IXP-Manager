                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <a class="btn btn-white btn-delete-pi" <?php if( $t->resellerMode() && ( $pi->peeringPhysicalInterface || $pi->fanoutPhysicalInterface ) ) :?> data-related="1" <?php endif; ?> data-type="<?= $pi->switchPort->type ?>" data-url="<?= route( 'physical-interface@delete', [ 'pi' => $pi->id ] ) ?>" href="#" title="Delete Physical Interface">
