    ...
    <div class="alert alert-warning mt-4" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div class="col-sm-12">
                ...
                <a href="<?= route('core-bundle@edit' , [ 'cb' => $t->cb->getId() ]) ?>"> accessed by clicking here </a>
            </div>
        </div>
    </div>
<?php endif; ?>
    ...
    <div class="card-body">
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <?php
                if( $t->cb ) {
                    $bbtn = '<a href="' . route( 'core-bundle@edit', [ 'cb' => $t->cb->getId() ] ) . '" class="btn btn-secondary mb-2 mb-md-2 mb-lg-0">Return to Core Bundle</a>';
                } elseif( $t->vi ) {
