...
<?php $this->section('content') ?>
    ...
    <div class="alert alert-info" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div class="col-sm-12">
                This report shows any ports allocated to members who are in the following states:
                <ul>
                    <li> Ceased (because their leave date is set). </li>
                    <li> Their status is not set to 'Normal'. </li>
                    <li> They are set as an associate member. </li>
                </ul>
                Ports allocated to members in these states may need to be deprovisioned.
            </div>
        </div>
    </div>
                ...
                <tbody>
                    <?php foreach( $t->vis as $vi ): ?>
                        <tr>
                            ...
                            <td>
                                <?php if( $vi[ 'dateleave' ] ): ?>
                                    <span class="badge badge-info">Ceased</span>
                                <?php endif; ?>
                                <?php if( $vi[ 'custstatus' ] !== \IXP\Models\Customer::STATUS_NORMAL ): ?>
                                    <span class="badge badge-info">Status not normal</span>
                                <?php endif; ?>
                                <?php if( $vi[ 'custtype' ] === \IXP\Models\Customer::TYPE_ASSOCIATE ): ?>
