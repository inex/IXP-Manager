...
<?php $this->section( 'page-header-preamble' ) ?>
    <li class="pull-right">
        <div class="btn-group btn-group-xs" role="group">
            <a type="button" class="btn btn-default" href="<?= route('interfaces/virtual/list' ) ?>" title="list">
                            ...
                            <?php if( count( $t->vi->getPhysicalInterfaces()  ) ) : ?>
                                <?php foreach( $t->vi->getPhysicalInterfaces() as $pi ):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ( !$pi->getSwitchPort()->isTypeFanout() ): ?>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a class="btn btn btn-default" href="<?= route( 'interfaces/physical/view' , [ 'id' => $pi->getId() ] ) ?>" title="view">
                            ...
                            <?php if( count( $t->vi->getVlanInterfaces()  ) ) : ?>
                                <?php foreach( $t->vi->getVlanInterfaces() as $vli ):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a class="btn btn btn-default" href="<?= route( 'interfaces/vlan/view' , [ 'id' => $vli->getId() ] )?>" title="View">
                                                    <i class="glyphicon glyphicon-eye-open"></i>
                                                </a>
