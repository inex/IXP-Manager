        ...
        <div class="tw:divide-y tw:divide-gray-200 tw:overflow-hidden tw:rounded-lg tw:bg-white tw:shadow tw:mb-8">
            <div class="tw:px-4 tw:py-5 tw:sm:px-6">
                        ...
                        <h1 class="tw:text-lg tw:font-semibold tw:leading-6 tw:text-gray-900">
                            ...
                            <button type="button" class="tw:ml-2 tw:rounded tw:bg-white tw:px-2 tw:py-1 tw:text-xs tw:font-semibold tw:text-gray-900 tw:shadow-sm tw:ring-1 tw:ring-inset tw:ring-gray-300 tw:hover:bg-gray-50"
                ...
                <div>
                    <table class="tw:min-w-full tw:divide-y tw:divide-gray-300">
                        ...
                        <?php foreach( $drs->results as $r ): ?>
                            ...
                            <tr>
                                <td class="tw:whitespace-nowrap tw:py-2 tw:pl-4 tw:px-3 tw:text-sm tw:sm:pl-0 tw:w-20">
                                    <?= $r->badge() ?>
                                </td>

                                <td class="tw:whitespace-nowrap tw:pl-4 tw:px-3 tw:text-sm tw:sm:pl-0 tw:w-10">
                                    <button type="button" class="tw:ml-4 tw:rounded tw:bg-white tw:px-2 tw:py-1 tw:text-xs tw:font-semibold tw:text-gray-900 tw:shadow-sm tw:ring-1 tw:ring-inset tw:ring-gray-300 tw:hover:bg-gray-50"
