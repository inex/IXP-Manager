            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-sm">
                        ...
                        <a class="btn btn-white usr-list-delete btn-delete-c2u" id="usr-list-delete-<?= $c2u->getId() ?>" href="<?= count( $c2u->getUser()->getCustomers() ) > 1 ? route( 'customer-to-user@delete' ) : route(  'user@delete' )  ?>" title="Delete">
