...
You have opted to connect to INEX using {{ count( $c->getVirtualInterfaces() ) }} ports. We have assigned the following IP addresses and switch ports for your connections:

@php ($numconnections = 1)
@foreach( $c->getVirtualInterfaces() as $connection )

Connection {{ $numconnections }}
============================================

LAG Port:        @if( count( $connection->getPhysicalinterfaces() ) > 1 ) Yes, comprising of: @else No @endif

802.1q Tagged:   @if($connection->getTrunk()) Yes @else No @endif
...
@else
IPv6:          Please contact us at {{ $identityEmail }} to enable IPv6
@endif
...
@else
IPv4:          Please contact us at {{ $identityEmail }} to enable IPv4
@endif
...
@else
Please contact us for your account details at {{ @identityEmail }}.
@endif
...
External Connections to the {{ $identityOrgname }} Infrastructure
===============================================
