...
?>
#
# Bird v3 Route Collector configuration generated by IXP Manager
#
...
<?= $t->insertif('api/v4/router/collector/bird3/threads_' . $t->handle) ?: $t->insertif('api/v4/router/collector/bird3/threads') ?>
