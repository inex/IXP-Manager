...
<?php if( config( 'ixp.rpki.rtr1.min_version' ) !== null ) { echo "    min version " . config( 'ixp.rpki.rtr1.min_version' ) . ";\n"; } ?>
<?php if( config( 'ixp.rpki.rtr1.max_version' ) !== null ) { echo "    max version " . config( 'ixp.rpki.rtr1.max_version' ) . ";\n"; } ?>
...
<?php if( config( 'ixp.rpki.rtr2.min_version' ) !== null ) { echo "    min version " . config( 'ixp.rpk2.rtr1.min_version' ) . ";\n"; } ?>
<?php if( config( 'ixp.rpki.rtr2.max_version' ) !== null ) { echo "    max version " . config( 'ixp.rpk2.rtr1.max_version' ) . ";\n"; } ?>
