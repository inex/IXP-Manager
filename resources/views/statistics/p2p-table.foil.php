            ...
            <nav id="filter-row" class="navbar navbar-expand-lg navbar-light bg-light mb-4 shadow-sm">
                <a class="navbar-brand" href="<?=
                    Auth::user()->isSuperUser()
                            ? route( 'statistics@p2p-table', [ 'custid' => $c->id ] )
                            : route('statistics@p2p-table')
                ?>">
                    P2P Table:
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <form class="navbar-form navbar-left form-inline d-block d-lg-flex" action="<?= route('statistics@p2p-table:post' ) ?>" method="post">
                            ...
                            <?php if ( $c ): ?>
                            <li class="nav-item float-right">
                                <a class="btn btn-white ml-2" href="<?= route( 'statistics@p2ps-get', [ 'customer' => $t->c->id ] ) ?>">Legacy P2P View</a>
                            </li>
                            <?php endif; ?>
                        </form>
                    </ul>
