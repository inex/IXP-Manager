    ...
    <?php if( !isset( $t->feParams->readonly ) || !$t->feParams->readonly ): ?>
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            <li>
                ...
                <a href="<?= route( 'ipAddress@preDeleteForVlan' , [ 'vlan' =>    $t->row['id'] ]   ) ?>"                      >Delete free IP addresses in VLAN</a>
                <a href="<?= route( 'ipAddress@preDeleteForVlan' , [ 'vlan' => $t->row['id'] , 'network' => true ]   ) ?>" >Delete free IP addresses in a given network</a>
            </li>
        </ul>
