<div class="btn-group">
    ...
    <a class="btn btn-sm btn-default" href="<?= route('console-server-connection@listPort' , [ 'port' => $t->row[ 'id' ] ] ) ?>" title="List Console Server Connections"><i class="glyphicon glyphicon-list"></i></a>
</div>
