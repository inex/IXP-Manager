...
class CoreBundle extends \Entities\CoreBundle implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'description', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'type', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'graph_title', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'created_at', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'updated_at', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'stp', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'enabled', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'bfd', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'ipv4_subnet', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'ipv6_subnet', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'cost', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'preference', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'id', '' . "\0" . 'Entities\\CoreBundle' . "\0" . 'coreLinks'];
        }
