...
class User extends \Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function addOtcRememberTokens(\Entities\OtpRememberTokens $otcRememberTokens)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addOtcRememberTokens', [$otcRememberTokens]);

        return parent::addOtcRememberTokens($otcRememberTokens);
    }

    /**
     * {@inheritDoc}
     */
    public function removeOtcRememberTokens(\Entities\OtpRememberTokens $otcRememberTokens)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeOtcRememberTokens', [$otcRememberTokens]);

        return parent::removeOtcRememberTokens($otcRememberTokens);
    }
    ...
    public function getOtcRememberTokens()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOtcRememberTokens', []);

        return parent::getOtcRememberTokens();
    }
