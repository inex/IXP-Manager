...
class Router extends \Entities\Router implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Router' . "\0" . 'id', '' . "\0" . 'Entities\\Router' . "\0" . 'handle', '' . "\0" . 'Entities\\Router' . "\0" . 'protocol', '' . "\0" . 'Entities\\Router' . "\0" . 'type', '' . "\0" . 'Entities\\Router' . "\0" . 'name', '' . "\0" . 'Entities\\Router' . "\0" . 'created_at', '' . "\0" . 'Entities\\Router' . "\0" . 'shortname', '' . "\0" . 'Entities\\Router' . "\0" . 'router_id', '' . "\0" . 'Entities\\Router' . "\0" . 'peering_ip', '' . "\0" . 'Entities\\Router' . "\0" . 'asn', '' . "\0" . 'Entities\\Router' . "\0" . 'software', '' . "\0" . 'Entities\\Router' . "\0" . 'software_version', '' . "\0" . 'Entities\\Router' . "\0" . 'operating_system', '' . "\0" . 'Entities\\Router' . "\0" . 'operating_system_version', '' . "\0" . 'Entities\\Router' . "\0" . 'mgmt_host', '' . "\0" . 'Entities\\Router' . "\0" . 'api', '' . "\0" . 'Entities\\Router' . "\0" . 'api_type', '' . "\0" . 'Entities\\Router' . "\0" . 'lg_access', '' . "\0" . 'Entities\\Router' . "\0" . 'quarantine', '' . "\0" . 'Entities\\Router' . "\0" . 'bgp_lc', '' . "\0" . 'Entities\\Router' . "\0" . 'rpki', '' . "\0" . 'Entities\\Router' . "\0" . 'rfc1997_passthru', '' . "\0" . 'Entities\\Router' . "\0" . 'skip_md5', '' . "\0" . 'Entities\\Router' . "\0" . 'template', '' . "\0" . 'Entities\\Router' . "\0" . 'updated_at', '' . "\0" . 'Entities\\Router' . "\0" . 'vlan'];
        }
