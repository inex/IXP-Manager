...
class PatchPanelPortHistoryFile extends \Entities\PatchPanelPortHistoryFile implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'created_at', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'updated_at', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'name', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'type', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'uploaded_at', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'uploaded_by', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'size', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'storage_location', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'id', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'is_private', '' . "\0" . 'Entities\\PatchPanelPortHistoryFile' . "\0" . 'patchPanelPortHistory'];
        }
