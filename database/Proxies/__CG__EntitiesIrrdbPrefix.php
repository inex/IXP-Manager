...
class IrrdbPrefix extends \Entities\IrrdbPrefix implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entities\\IrrdbPrefix' . "\0" . 'prefix', '' . "\0" . 'Entities\\IrrdbPrefix' . "\0" . 'protocol', '' . "\0" . 'Entities\\IrrdbPrefix' . "\0" . 'first_seen', '' . "\0" . 'Entities\\IrrdbPrefix' . "\0" . 'last_seen', '' . "\0" . 'Entities\\IrrdbPrefix' . "\0" . 'id', '' . "\0" . 'Entities\\IrrdbPrefix' . "\0" . 'Customer');
        }
