...
class Logo extends \Entities\Logo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Logo' . "\0" . 'original_name', '' . "\0" . 'Entities\\Logo' . "\0" . 'stored_name', '' . "\0" . 'Entities\\Logo' . "\0" . 'uploaded_by', '' . "\0" . 'Entities\\Logo' . "\0" . 'uploaded_at', '' . "\0" . 'Entities\\Logo' . "\0" . 'width', '' . "\0" . 'Entities\\Logo' . "\0" . 'height', '' . "\0" . 'Entities\\Logo' . "\0" . 'id', '' . "\0" . 'Entities\\Logo' . "\0" . 'customer'];
        }
