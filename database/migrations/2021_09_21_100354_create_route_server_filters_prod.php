...
final class CreateRouteServerFiltersProd extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('route_server_filters_prod', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('route_server_filters_prod');
    }
}