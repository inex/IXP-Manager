...
$options = array (
	...
	'--watermark=Copyright '. date('Y') .' '.$config->identity->orgname.' - Generated: '.date('Y-m-d G:i:s'),
...
if ($separated_maxima) {
	$options[] = 'LINE2:cdefb#ff00ff:Peak '.$srcvliowner.' to '.$dstvliowner;
	$options[] = 'GPRINT:max_in:\tMax\\:%8.2lf%s\l';
	$options[] = 'AREA:cdefd#006600:Peak '.$dstvliowner.' to '.$srcvliowner;
