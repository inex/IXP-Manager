...
//
$PHP_SELF= $BU; //isset($_SERVER['PHP_SELF']) ? htmlentities(strip_tags($_SERVER['PHP_SELF'],''), ENT_QUOTES) : '';
$time = time();
...
$GLOBALS['MY_SELF_WO_SORT'] = $MY_SELF_WO_SORT;
...
$GLOBALS['AUTHENTICATED'] = $AUTHENTICATED;
