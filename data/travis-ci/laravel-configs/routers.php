...
return [
    ...
    'as112-lan1-ipv4' => [
        'vlan_id'    => 1,
        'protocol'   => 4,
        'type'       => 'AS112',   // RC|RS|AS112?
        'name'       => 'INEX LAN1 - AS112 Service - IPv4',
        'shortname'  => 'AS112 - LAN1 - IPv4',
        'router_id'  => '192.0.2.6',
        'peering_ip' => '192.0.2.6',
        'asn'        => 112,
        'software'   => 'bird',
        'mgmt_ip'    => '203.0.113.6',
        'api'        => 'http://as112-lan1-ipv4.mgmt.example.com/api',
        'api_type'   => 'birdseye',
        'lg_access'  => Entities\User::AUTH_PUBLIC,
        'bgp_lc'     => false,
        'quarantine' => false,
    ...
    'as112-lan1-ipv6' => [
        ...
        'protocol'   => 6,
        'type'       => 'AS112',   // RC|RS|AS112?
        'name'       => 'INEX LAN1 - AS112 Service - IPv6',
        'shortname'  => 'AS112 - LAN1 - IPv6',
        'router_id'  => '192.0.2.6',
        'peering_ip' => '2001:db8:0:0:2::6',
        'asn'        => 112,
        'software'   => 'bird',
        'mgmt_ip'    => '203.0.113.6',
        'api'        => 'http://as112-lan1-ipv6.mgmt.example.com/api',
        'api_type'   => 'birdseye',
        'lg_access'  => Entities\User::AUTH_PUBLIC,
        'bgp_lc'     => false,
        'quarantine' => false,
    ...
    'as112-lan2-ipv4' => [
        ...
        'protocol'   => 4,
        'type'       => 'AS112',   // RC|RS|AS112?
        'name'       => 'INEX LAN2 - AS112 Service - IPv4',
        'shortname'  => 'AS112 - LAN2 - IPv4',
        'router_id'  => '192.0.2.16',
        'peering_ip' => '192.0.2.16',
        'asn'        => 112,
        'software'   => 'bird',
        'mgmt_ip'    => '203.0.113.16',
        'api'        => 'http://as112-lan2-ipv4.mgmt.example.com/api',
        'api_type'   => 'birdseye',
        'lg_access'  => Entities\User::AUTH_PUBLIC,
        'bgp_lc'     => false,
        'quarantine' => false,
    ...
    'as112-lan2-ipv6' => [
        ...
        'protocol'   => 6,
        'type'       => 'AS112',   // RC|RS|AS112?
        'name'       => 'INEX LAN2 - AS112 Service - IPv6',
        'shortname'  => 'AS112 - LAN2 - IPv6',
        'router_id'  => '192.0.2.16',
        'peering_ip' => '2001:db8:0:0:2::16',
        'asn'        => 112,
        'software'   => 'bird',
        'mgmt_ip'    => '203.0.113.16',
        'api'        => 'http://as112-lan2-ipv6.mgmt.example.com/api',
        'api_type'   => 'birdseye',
        'lg_access'  => Entities\User::AUTH_PUBLIC,
        'bgp_lc'     => false,
        'quarantine' => false,
